...
# -- IMPORTANT
data=/mnt/data0/LipReadingData/data_pcg_new_52_person+aishell_16000_with_noise_test_10DB # Modify to your aishell data path
# data=/home/pcg/data/data_pcg_new_52_person
...
dumpdir=dataset/new_52_person   # directory to dump full features
